...
public class Cylinder extends Tube {
	...
	/**
	 * Constructs a cylinder with radius, height and axis ray and color and material
	 * 
	 * @param material
	 * @param color
	 * @param double   _radius, radius of the cylinder
	 ...
	 * @throws new IllegalException when radius is smaller than zero
	 */
	public Cylinder(Material material, Color color, double _radius, double _height, Ray _axis) {
		super(material, color, _axis, _radius);
		if (_height > 0)
			this.height = _height;
		else {
			throw new IllegalArgumentException("Radius is smaller than zero");
